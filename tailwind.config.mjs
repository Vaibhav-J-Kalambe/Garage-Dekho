...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        // ── Stitch Design System Tokens (CSS variable-backed for dark mode) ──
        ...
        "accent-light":"rgb(var(--color-primary-fixed) / <alpha-value>)",
        "card":        "rgb(var(--color-surface-container-lowest) / <alpha-value>)",
        "border":      "rgb(var(--color-outline-variant) / <alpha-value>)",
        "muted":       "rgb(var(--color-on-surface-variant) / <alpha-value>)",

        // Hardcoded (same in light & dark)
        "brandOrange": "#FF6B00",
      },
      borderRadius: {
        "DEFAULT": "0.5rem",
