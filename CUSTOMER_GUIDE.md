...
1. Open GarageDekho in your browser
...
### Browse Nearby Garages (Home Page)
...
Tap **Near Me** in the bottom navigation.

- Shows a live map with garage pins around you
- Tap a pin on the map to see that garage's details
- Tap **List** to switch to a scrollable list view

### What You See on a Garage Page

- Garage name, address, phone number
- Services they offer (tyre, battery, engine, etc.)
- Working hours and days closed
- Distance from your location
- WhatsApp button to contact them directly
- Similar garages nearby

---

## Booking a Service

1. Open a garage's page
2. Tap **Book Service**
3. Select the service you need
4. Choose a date and time
5. Confirm your booking

Your booking will appear under the **Bookings** tab. The garage will contact you to confirm.

> **Note:** You must be signed in to book.
...
- Car battery died
- Engine broke down unexpectedly
- Accident or any roadside emergency
...
### Can I use SOS without an account?

Yes. SOS works for guest users. However, if you're logged in, your request is linked to your account for history and support purposes.
...
- Add or update vehicles (make, model, year, number plate)
- Sign out
...
Your vehicles appear when booking a service so the garage knows what they're working on.
...
- **The OTP screen stays visible** until the mechanic enters it. Don't close it.

---

## Frequently Asked Questions

**Is GarageDekho free to use?**
Yes, the app is free for customers. You only pay the garage for the service they provide.

**How do I cancel an SOS request?**
Tap **Cancel Request** at the bottom of the searching screen. If a mechanic has already been dispatched, please call them directly to inform them.

**What if no garages are nearby?**
The app shows you garages up to 10 km away. If none appear, use the emergency call button or contact a garage directly via their WhatsApp link.
