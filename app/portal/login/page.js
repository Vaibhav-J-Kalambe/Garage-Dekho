...
const FEATURES = [
  {
    ...
    text: "Verified Partis applner Badge",
  },
  {
    icon: (
    ...
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden overflow-hidden lg:flex lg:w-[52%] lg:flex-col bg-gradient-to-br from-[#001f5b] via-[#003091] to-[#0056D2]">
        ...
        <Link
          ...
          className="absolute left-6 top-4 z-20 flex h-10 w-10 items-center justify-center rounded-full bg-white/15 text-white transition-colors duration-150 hover:bg-white/25 active:scale-95"
        >
          ...
          <div className="w-full max-w-sm rounded-2xl border border-slate-100 bg-white p-5 shadow-md sm:p-6">
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="portal-email" className="text-xs font-bold uppercase tracking-wide text-slate-500">Email</label>
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="portal-password" className="text-xs font-bold uppercase tracking-wide text-slate-500">Password</label>
                <div className="relative">
                  <svg className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>
                  </svg>
                  <input id="portal-password" type={showPass ? "text" : "password"} required value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" autoComplete="current-password" style={{ fontSize: 16 }} className="w-full rounded-xl border border-slate-200 bg-slate-50 py-3 pl-10 pr-12 text-slate-900 outline-none transition-[border-color,box-shadow] duration-150 focus:border-[#0056D2] focus:bg-white focus:ring-2 focus:ring-[#0056D2]/15 min-h-[44px]" />
